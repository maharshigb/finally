// Mobile device and tablet detection (runs immediately or on DOMContentLoaded fallback)
(function() {
    ...
    if (isMobile) {
        ...
        const applyMobileClasses = () => {
            ...
            document.getElementById('mobile-device')?.classList.add('is-mobile-device');
        };
